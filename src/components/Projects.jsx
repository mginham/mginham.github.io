                ...
                {projects.map((project, index) => (
                    <div key={index} className="w-[360px] h-[350px]">
                            ...
                            project.external ? (
                                <a href={project.link} target="_blank" rel="noopener noreferrer">
                                    <img
                                        ...
                                        alt={project.title}
                                        className="h-[70%] w-full rounded-3xl p-2 object-cover border border-transparent hover:border-text-primary hover:shadow-lg transition"
                                    />
                                </a>
                            ) : (
                                <a href={project.link}>
                        ...
                        <img
                            src={getImage(project.image)}
                            alt={project.title}
                            className="h-[70%] w-full rounded-3xl p-2 object-cover border border-transparent hover:border-text-primary"
                        />
                        )}
